    ...
    <footer className="bg-gov-primary text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white/60">
        ...
        <div className="flex divide-x divide-white/20">
          ...
          <Link href="/about" className="px-4 hover:text-white transition-colors">Accessibility</Link>
          <Link href="/about" className="px-4 hover:text-white transition-colors">Disclaimer</Link>
          <a href="https://parliament.gov.sb" target="_blank" rel="noopener noreferrer" className="px-4 hover:text-white transition-colors">parliament.gov.sb</a>
        </div>
      </div>
    </footer>
  );
